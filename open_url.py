...
and for sending e-mail using the user's preferred composer.From http://code.activestate.com/recipes/511443/
Recipe 511443: Cross-platform startfile and mailto functions 
